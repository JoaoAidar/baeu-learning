...
status: active
date: 2026-05-30
generated_at: 2026-05-30T13:27:47.789052+00:00
source: /Users/joaoadair/Documents/Obsidian Vault/70-analysis/fleet-checkups/2026-05-30-fleet-e2e-cicd-check.md
...
| --- | --- | ---: | --- |
| web | 3/3 `[200]` | 174.1ms | <!doctype html> <html lang="en">   <head>     <meta charset="UTF-8" />     <meta name="viewport" content="width=device-width, initial-scale=1.0" />     <title>Baeu — Korean Practic |
| api_health | 3/3 `[200]` | 549.8ms | {"ok":true,"store":"pg"} |

## E2E Findings

| Check | Status | HTTP | Timing | Note |
| --- | --- | ---: | ---: | --- |
| web | `pass` | 200 | 197.3ms | <!doctype html> <html lang="en">   <head>     <meta charset="UTF-8" />     <meta name="viewport" content="width=device-width, initial-scale=1.0" />     <title>Baeu — Korean Practic |
