...
status: active
date: 2026-05-25
generated_at: 2026-05-25T00:47:37.923729+00:00
source: /Users/joaoadair/Documents/Obsidian Vault/70-analysis/fleet-checkups/2026-05-25-fleet-e2e-cicd-check.md
...
| --- | --- | ---: | --- |
| web | 2/2 `[200]` | 40.2ms | <!doctype html> <html lang="en">   <head>     <meta charset="UTF-8" />     <meta name="viewport" content="width=device-width, initial-scale=1.0" />     <title>Baeu — Korean Practic |
| api_health | 2/2 `[200]` | 408.3ms | {"ok":true,"store":"pg"} |

## E2E Findings

| Check | Status | HTTP | Timing | Note |
| --- | --- | ---: | ---: | --- |
| web | `pass` | 200 | 42.7ms | <!doctype html> <html lang="en">   <head>     <meta charset="UTF-8" />     <meta name="viewport" content="width=device-width, initial-scale=1.0" />     <title>Baeu — Korean Practic |
